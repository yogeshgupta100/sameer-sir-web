...
export default function NavModal({ navModalActive }) {
		...
		>
			...
			>
				...
				>
                    ...
                    <button style={{ color: "white", backgroundColor: "#B46BD1", outline: "none", border: 'none', fontSize: "14px", padding: "0.5rem 1rem", borderRadius: "0.5rem", width: "fit-content" }}>Explore more</button>
				</div>
			</div>
		</div>
	);
