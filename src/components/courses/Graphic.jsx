					...
					<div className="landing-page" id="home-main">
						<div className="landing-page-content">
							<div className="centered-text">
								...
								<div
									style={{ display: "flex", width: "70%", justifyContent: "flex-start", gap: "1rem" }}
								>
									<button
										type="button"
					...
					<div className=" about-first2">
						...
						>
							...
							>
								...
								>
									Welcome to the enchanting world of "Graphic Design Alchemy," where creativity knows
									no bounds, and the ordinary transforms into extraordinary. it's a journey of
