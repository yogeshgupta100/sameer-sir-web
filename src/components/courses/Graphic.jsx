				...
				<div className="about" style={{ maxWidth: "100vw", display: "flex", justifyContent: "center" }}>
					<div className=" about-first2">
						<div
							...
							style={{ display: "grid", gridTemplateColumns: "8fr 1fr 4fr 1fr 4fr", textAlign: "center" }}
						>
							<div
								className="part1"
							...
							>
								...
								>
									At Dxolve , we are passionate about empowering creative minds to shape the digital
									world of tomorrow. We believe in the transformative power of design, and our mission
									is to provide an exceptional learning experience that nurtures the design talents of
							...
							<div
								className="h-line"
								style={{ minWidth: "100%", height: "0.1vw", display: "none", margin: "auto" }}
							></div>
							<div
								className="part3"
								style={{ display: "flex", flexDirection: "column", alignItems: "center" }}
