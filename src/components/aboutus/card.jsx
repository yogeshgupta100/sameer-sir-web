...
const EmpCard = ({ currEle }) => {
	...
	return (
		...
		>
			...
			>
				<span className="card-emp-content" style={{ marginBottom: "5px", color: "#fff" }}>
					{currEle?.name}
				</span>
			...
			<div className="hidden-content">
				<div className="hidden-container" style={{ padding: "0 0 4vw" }}>
					<div style={{ whiteSpace: "nowrap", fontSize: "clamp(1rem , 3vw , 1.5rem)", color: "#fff" }}>
					...
					<div style={{ fontSize: "clamp(0.5rem , 3vw , 1rem)", letterSpacing: "1", lineHeight: "1.5" }}>
						{currEle?.description}
					</div>
					<hr style={{ margin: "0.8vw 0" }} />
				</div>
