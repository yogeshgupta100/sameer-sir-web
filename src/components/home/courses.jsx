            ...
            return(
                <div className="row justify-content-around">
                        <div className="card my-3 px-0">
                            <img src={currEle.imageUrl} className="card-img-top" alt='course1'/>
                    <div className="card-body container" style={{
                        ...
                        <div className="container"  style={{
                            ...
                            <div className="content">
                                ...
                                <p className='course-content'>{currEle.startDate}</p>
                            </div>
                            ...
                            <div className="content">
                                ...
                                <p className='course-content'>{currEle.courseSize}</p>
                            </div>
                            <div className="v-line" style={{
                                margin:"0 0.81rem 0"
                            }}></div>
                            <div className="content">
                                ...
                                <p className='course-content'>{currEle.Duration}</p>
                            </div>
                        </div>
